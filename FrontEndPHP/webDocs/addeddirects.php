<title>"directs" relationship added</title>
...
if(isset($_POST['submit'])){
    ...
    if(empty($data_missing)){
        ...
        $query = "INSERT INTO directs(pid, fid)
        VALUES (?, ?)";
...
?>
<!--allows for another entry-->
<form action="addedmakes.php" method="post">
  <center>
    <h1>Add a "Directs" relationship</h1>
    <p>Person ID:
